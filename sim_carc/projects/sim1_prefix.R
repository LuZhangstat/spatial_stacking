...
deltasq_grid2 <- pick_deltasq(E_sigmasq = 1, E_tausq = 1, b = 2,
                              p_ls = c(0.2, 0.4, 0.6, 0.8))
deltasq_grid2

# test 3: posterior sample from marginal distribution #
data_filename <- paste0("./sim_hoffman2/results/sim1_", input_id, ".Rdata")
load(data_filename)
...
output_filename <- paste0("./sim_carc/results/sim1_", input_id, "_prefix2.Rdata")
